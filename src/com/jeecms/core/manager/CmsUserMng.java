...
public interface CmsUserMng {
	public Pagination getPage(String username, String email, Integer siteId,
			...
			Boolean allChannel,
			int pageNo, int pageSize,CmsUser currUser);
	...
	public CmsUser registerMember(String username, String email,
			String password, String ip, Integer groupId, String partyId, boolean disabled,CmsUserExt userExt,Map<String,String>attr, Boolean activation , EmailSender sender, MessageTemplate msgTpl)throws UnsupportedEncodingException, MessagingException ;
	...
	public CmsUser updateAdmin(CmsUser bean, CmsUserExt ext, String password,
			Integer groupId,Integer[] roleIds, Integer[] channelIds,
			Integer siteId, Byte step, Boolean allChannel, String partyId);
	...
	public CmsUser saveAdmin(String username, String email, String password,
			String ip, boolean b, Boolean selfAdmin, Integer rank,
			Integer groupId, Integer[] roleIds,String partyId, Integer[] channelIds,
			Integer[] siteIds, Byte[] steps, Boolean[] allChannels,
			CmsUserExt ext);

	public CmsUser findByPhone(String username);
