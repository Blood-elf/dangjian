...
public abstract class BaseCmsUser  implements Serializable {
	...
	private com.jeecms.cms.entity.main.PartyCommittee party;
	...
	public com.jeecms.cms.entity.main.PartyCommittee getParty() {
		return party;
	}

	public void setParty(com.jeecms.cms.entity.main.PartyCommittee party) {
		this.party = party;
	}
