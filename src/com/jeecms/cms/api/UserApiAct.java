...
public class UserApiAct {
		...
		if(errors.hasErrors()){
			...
			if(record!=null){
				...
				if(user==null){
					...
					user=cmsUserMng.registerMember(username, email, loginPassword, ip, null,null,disabled,userExt,attrs,null);
	...
	private String thirdLoginGetSessionKey(ApiAccount apiAccount,
		...
		if(thirdAccount!=null){
			...
			CmsUser user=cmsUserMng.registerMember(username, null, thirdKey, ip, null,null,disabled,userExt,null,null);
