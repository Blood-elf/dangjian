...
public class FrameAct {
	...
	//党建地图
	@RequiresPermissions("frame:serviceMap_main")
	@RequestMapping("/frame/serviceMap_main.do")
	public String serviceMapMain(ModelMap model) {
		return "frame/serviceMap_main";
	}

	@RequiresPermissions("frame:serviceMap_left")
	@RequestMapping("/frame/serviceMap_left.do")
	public String serviceMapLeft(ModelMap model) {
		return "frame/serviceMap_left";
	}

	@RequiresPermissions("frame:serviceMap_right")
	@RequestMapping("/frame/serviceMap_right.do")
	public String serviceMapRight(ModelMap model) {
		return "frame/serviceMap_right";
	}
