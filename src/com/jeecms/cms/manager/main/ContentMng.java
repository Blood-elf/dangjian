...
public interface ContentMng {
	...
	public Pagination getPageByChannelIdsForTag(Integer[] channelIds,
			Integer[] typeIds, Boolean titleImg, Boolean recommend,
			String title,Map<String,String[]>attr, 
			int orderBy, int option,int pageNo, int pageSize,String isPublish);
	...
	public Pagination getPageByCustom(Integer share, String title,
			...
			ContentStatus status, Byte checkStep, Integer siteId, Integer channelId,
			Integer userId, Integer orderBy, int pageNo, int pageSize,
			JSONObject custom);
